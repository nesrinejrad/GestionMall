...
class User extends \MyApp\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'cartes', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'abonnements', 'invitation', '' . "\0" . 'MyApp\\UserBundle\\Entity\\User' . "\0" . 'boutique', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setInvitation(\MyApp\UserBundle\Entity\Invitation $invitation = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInvitation', [$invitation]);
